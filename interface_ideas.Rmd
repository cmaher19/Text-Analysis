...
What external data do we have to draw in?
  - Stop words
    - Have some option for designating your own stop words
  ...
  - Lexicons
    - Have some option for ignoring words → “Darling” example in Peter Pan
    - How many lexicons do we want to have available to choose from?
